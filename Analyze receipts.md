* Explain more the pre-built receipt model and demonstrates how the variation of the guidelines(images format, size..) will affect the result of the custom model 
